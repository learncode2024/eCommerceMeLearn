...
*/
$config['tables']['users']           = 'portal_master';
$config['tables']['groups']          = 'portal_groups';
$config['tables']['admin_group']    = 'portal_group_data';
$config['tables']['login_attempts']  = 'portal_login_attempts';
...
$config['maximum_login_attempts']     = 5;                   // The maximum number of failed login attempts.5
...
$config['email_config'] = [
	...
	'smtp_port' => 465,
	'smtp_user' => 'dctest2542',
	'smtp_pass' => 'dc@25042000',
	'crlf' => "\r\n",
	'newline' => "\r\n",
	'charset'   => 'iso-8859-1',
	'wordwrap'  => TRUE
