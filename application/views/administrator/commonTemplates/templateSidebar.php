            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?= base_url("/administrator"); ?>" class="app-brand-link">
                        <img src="<?php echo base_url(DARK_LOGO); ?>" alt="logo" width="130px">
                    </a>
                ...
                <ul class="menu-inner py-3">
                    ...
                    <li class="menu-item  <?= (@$loadPage == 'dashboard') ? 'active' : ''; ?>">
                        <a href="<?php echo base_url('administrator/home/') ?>" class="menu-link">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?php echo base_url('administrator/login/logOut'); ?>">
